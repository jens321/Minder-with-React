        ...
        return (
            <div className="tag-wrap">
                ...
                <div className="tag-list">
                    {this.props.tags.length !== 0 ? this.props.tags.map((tag, index) => <Tag key={index} text={tag} deleteTag={this.props.handleTagDelete}/>) : <p className="item">You did not specify any tags yet.</p>}
                </div> 
